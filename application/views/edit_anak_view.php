				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<?php echo form_open_multipart('Anak/update/'.$this->uri->segment(3)); ?>
								...
								<tr>
									...
									<input type="date" format="dd/mm/yyyy" placeholder="Masukkan Tanggal Lahir" class="form-control" id="tanggal_lahir" name="tanggal_lahir" aria-describedby="basic-addon3" value="<?php echo $anak[0]->tanggal_lahir ?>">
									</td>
								</tr>
