	...
	<body>
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<table class="table table-hover" id="example">
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td align="center">
											<a href="<?php echo site_url('anak/index/').$key->id ?>" type="button" class="btn btn-success">Hero</a>
					...
					<a href="<?php echo site_url()?>/pegawai/create" class="btn btn-primary"> <span class=""></span> Tambah Jenis Hero</a>
